...
bot = telebot.TeleBot('7410121310:AAHfR_PN6iWsomj4U3Dy-5fOyFzdyyc8hiQ')
...
def show_recent_logs(message):
    ...
    if user_id in admin_id:
        ...
        response = "ꜰʀᴇᴇ ᴋᴇ ᴅʜᴀʀᴍ ꜱʜᴀʟᴀ ʜᴀɪ ᴋʏᴀ ᴊᴏ ᴍᴜ ᴜᴛᴛʜᴀ ᴋᴀɪ ᴋʜɪ ʙʜɪ ɢᴜꜱ ʀʜᴀɪ ʜᴏ ʙᴜʏ ᴋʀᴏ ꜰʀᴇᴇ ᴍᴀɪ ᴋᴜᴄʜ ɴʜɪ ᴍɪʟᴛᴀ ʙᴜʏ:- @Mr_MajaRuL3799 ☠️."
        bot.reply_to(message, response)
...
def start_attack_reply(message, target, port, time):
    ...
    response = f"{username}, 𝐇𝐀𝐂𝐊 𝐒𝐓𝐀𝐑𝐓𝐄𝐃 🔥🔥\n\n𝐓𝐚𝐫𝐠𝐞𝐭: {target}\n𝐏𝐨𝐫𝐭: {port}\n𝐓𝐢𝐦𝐞: {time} 𝐒𝐞𝐜𝐨𝐧𝐝𝐬\n𝐌𝐞𝐭𝐡𝐨𝐝: 𝘔𝘢𝘥𝘦 𝘉𝘺 MAJARUL ( MJ ) 😎"
    bot.reply_to(message, response)
    ...
    if user_id in allowed_user_ids:
        ...
        if len(command) == 4:  # Updated to accept target, time, and port
            ...
            if time > 600:
                ...
                record_command_logs(user_id, '/mj', target, port, time)
...
Buy From :- @Mr_MajaRuL3799 😎
Official Channel :- https://t.me/MjGaming99
'''
...
3. MAKE SURE YOU JOINED https://t.me/MjGaming_GroupChat OTHERWISE NOT WORK
